...
| **Default**     | 0                                                                                 |
+-----------------+-----------------------------------------------------------------------------------+
| **Description** | Enables XP save for all the gametypes                                             |
+-----------------+-----------------------------------------------------------------------------------+
...
| **1** | Enable XPSave                                                                               |
+-------+---------------------------------------------------------------------------------------------+
| **2** | No Reset on map restarts (only by vote)                                                     |
+-------+---------------------------------------------------------------------------------------------+
| **4** | No Reset Ever                                                                               |
+-------+---------------------------------------------------------------------------------------------+
| **8** | Call ClientDisconnect() on clients with the same GUID                                       |
+-------+---------------------------------------------------------------------------------------------+
|**16** | Disabled XPSave for Gametype Stopwatch                                                      |
+-------+---------------------------------------------------------------------------------------------+
|**32** | When Enabled it tries to convert/import old .xp file into etl database,                     |
|       | can be unset after it is done. Default xpsave directory                                     |
+-------+---------------------------------------------------------------------------------------------+
...
| **Range**       | any positive integer                                                              |
+-----------------+-----------------------------------------------------------------------------------+
| **Description** | The number of seconds that must pass without a connection from this player before |
|                 | XPSave forgets their XP and skills and medals.                                    |
+-----------------+-----------------------------------------------------------------------------------+
